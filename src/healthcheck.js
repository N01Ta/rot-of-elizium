...
const intervalSeconds = parseInt(process.env.ROTOFELIZIUM_HEARTBEATINTERVAL || '0');
...
const dataRoot = process.env.ROTOFELIZIUM_DATAROOT || path.join(serverDirectory, 'data');
