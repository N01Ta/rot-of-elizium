...
async function preSetupTasks() {
    ...
    console.log();
    console.log(`Rot of Elizium ${version.pkgVersion}`);
...
async function postSetupTasks(result) {
    ...
    setWindowTitle('Rot of Elizium');

    let logListen = 'Rot of Elizium is listening on';
    ...
    const goToLog = `Go to: ${color.blue(browserLaunchUrl)} to open Rot of Elizium`;
