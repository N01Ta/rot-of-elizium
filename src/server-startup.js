...
export class ServerStartup {
    ...
    #getAddressInUseMessage(url, ipVersion) {
        ...
        return `Address ${listenAddress} is already in use. Another Rot of Elizium instance may already be running. Stop the other process or change "port" in config.yaml.`;
    }
