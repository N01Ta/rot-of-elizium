 ...
 * @property {boolean} listen If Rot of Elizium is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch Rot of Elizium in the browser
...
export class CommandLineParser {
    ...
    getDefaultConfig(isGlobal) {
        const appPaths = envPaths('Rot of Elizium', { suffix: '' });
    ...
    parse(args) {
        const cliArguments = yargs(hideBin(args))
            ...
            .option('browserLaunchEnabled', {
                type: 'boolean',
                default: null,
                describe: 'Automatically launch Rot of Elizium in the browser',
            })
