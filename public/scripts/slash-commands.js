...
export function initDefaultSlashCommands() {
    ...
    SlashCommandParser.addCommandObject(SlashCommand.fromProps({
        ...
        <div>
            <strong>${t`Note on tags:`}</strong> ${t`The <code>tags</code> argument sets character card tags (embedded in the character file), not Rot of Elizium's folder/filter tags. To add ST tags after creation, use <code>/tag-add</code>. To import card tags as ST tags, use <code>/tag-import</code>.`}
        </div>
        <div>
    ...
    SlashCommandParser.addCommandObject(SlashCommand.fromProps({
        ...
        <div>
            <strong>${t`Note on tags:`}</strong> ${t`The <code>tags</code> argument sets character card tags (embedded in the PNG), not Rot of Elizium's folder/filter tags. To add ST tags, use <code>/tag-add</code>. To import card tags as ST tags, use <code>/tag-import</code>.`}
        </div>
        <div>
