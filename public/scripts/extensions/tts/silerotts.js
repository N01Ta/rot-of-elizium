...
class SileroTtsProvider {
    ...
    get settingsHtml() {
        ...
        <span>
        <span>Use <a target="_blank" href="https://github.com/RotOfElizium/SillyTavern-extras">Rot of Elizium Extras API</a> or <a target="_blank" href="https://github.com/ouoertheo/silero-api-server">Silero TTS Server</a>.</span>
        `;
        return html;
    }
