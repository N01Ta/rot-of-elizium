...
function getGalleryFolder(char) {
    return RotOfElizium.getContext().extensionSettings.gallery.folders[char?.avatar] ?? char?.name;
}
...
function getSortOrder() {
    return RotOfElizium.getContext().extensionSettings.gallery.sort ?? defaultSettings.sort;
}
